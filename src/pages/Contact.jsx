            ...
            <div className="lg:col-span-1 space-y-8 p-4 border-b lg:border-b-0 lg:border-r border-indigo-700/50">
                ...
                >
                    ...
                    <div className="flex space-x-4">
                        <SocialLink Icon={FaFacebookF} href="https://www.facebook.com/photo.php?fbid=486269748504166&set=pb.100013634345520.-2207520000&type=3" color="hover:text-blue-500" />
