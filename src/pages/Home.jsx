                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8 w-full">
                        ...
                        <div className="w-full flex flex-col items-start">
                            ...
                            <MotionLink
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="w-full px-4 sm:px-6 py-2 sm:py-3 bg-indigo-600 text-white font-bold rounded-full text-xs sm:text-sm md:text-base hover:bg-indigo-700 transition duration-300 break-words text-center inline-block"
                            >
